...
+ (UIImage *)originImageForAsset:(PHAsset *)asset {
    ...
    [[PHImageManager defaultManager] requestImageDataAndOrientationForAsset:asset options:phImageRequestOptions resultHandler:^(NSData * _Nullable imageData, NSString * _Nullable dataUTI, CGImagePropertyOrientation orientation, NSDictionary * _Nullable info) {
